...
elder_numeric_vars_table <- elder_adj %>% 
  ...
  tab_style(style = list(cell_text(color = "#00589B")),
            locations = cells_body(columns = Hist,
...
#gtsave(elder_numeric_vars_table, "elder_numeric_vars_table.png", vwidth = 1500, vheight = 1000)
